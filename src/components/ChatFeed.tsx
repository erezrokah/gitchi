  ...
  return (
    <Segment attached="bottom">
      <Feed>
        <Feed.Event>
          <Feed.Label>
            <img src={require('../images//avatar/small/elliot.jpg')} />
          </Feed.Label>
          <Feed.Content>
            <Feed.Summary>
        ...
        <Feed.Event>
          <Feed.Label image={require('../images/avatar/small/helen.jpg')} />
          <Feed.Content>
            <Feed.Summary>
            ...
            <Feed.Extra images>
              <a>
                <img src={require('../images/wireframe/image.png')} />
              </a>
              <a>
                <img src={require('../images/wireframe/image.png')} />
              </a>
        ...
        <Feed.Event>
          <Feed.Label image={require('../images/avatar/small/joe.jpg')} />
          <Feed.Content>
            <Feed.Summary>
        ...
        <Feed.Event>
          <Feed.Label image={require('../images/avatar/small/justen.jpg')} />
          <Feed.Content>
            <Feed.Summary>
